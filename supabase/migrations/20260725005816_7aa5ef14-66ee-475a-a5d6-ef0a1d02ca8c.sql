...
BEGIN
  ...
  -- Back-reference journal entry to the payment record for traceability.
  ...
  -- Audit trail so Finance → Audit can show who paid which invoice from a provider balance.
