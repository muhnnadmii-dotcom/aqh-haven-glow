...
const businessDefaults: PageDoc = {
  sections: [
    ...
    // 14) FAQ
    {
      ...
      heading: "أسئلة شائعة",
      items: [
        { id: newId(), q: "هل يصدر الحوض أي روائح داخل المكان؟", a: "لا. الحوض المصمم والمُدار بشكل صحيح لا يصدر روائح مزعجة. تعتمد الخدمة على ترشيح مناسب، جودة مياه مستقرة، وتنظيف دوري يمنع تراكم المخلفات." },
        { id: newId(), q: "هل يحتاج أحد من موظفينا إلى الاهتمام بالحوض؟", a: "لا في باقات الإدارة الكاملة. يتولى فريق Aqua Haven التغذية المجدولة، التنظيف، فحص المعدات، متابعة المياه، والعناية بالكائنات الحية، بينما يقتصر دور فريق المنشأة على الإبلاغ عن أي ملاحظة غير معتادة." },
        { id: newId(), q: "هل يمكن أن تؤثر الصيانة على العملاء أو سير العمل؟", a: "تُجدول الزيارات في الأوقات الأنسب للمنشأة، وتُنفذ بطريقة منظمة وسريعة مع الحفاظ على نظافة الموقع وتقليل أي إزعاج للعملاء والموظفين." },
        { id: newId(), q: "هل يمكن تنفيذ الصيانة قبل أو بعد ساعات العمل؟", a: "نعم، يمكن تنسيق الزيارات خارج أوقات الذروة أو قبل الافتتاح أو بعد الإغلاق متى كان ذلك ممكنًا حسب الموقع والباقـة." },
        { id: newId(), q: "ماذا يحدث إذا ماتت سمكة أو تضررت النباتات؟", a: "تختلف التغطية حسب الباقة والعقد. بعض الخطط المُدارة قد تشمل الاستبدال وفق سياسة الخدمة، بعد تحديد سبب المشكلة والتأكد من أنها ليست ناتجة عن تدخل خارجي أو ظرف خارج نطاق التغطية." },
        { id: newId(), q: "ماذا يحدث إذا تعطلت إحدى المعدات؟", a: "نقوم بتشخيص العطل وتحديد الإجراء المناسب. يتم الإصلاح أو الاستبدال وفق ضمان المعدات وشروط باقة الصيانة المتفق عليها." },
        { id: newId(), q: "هل يوجد خطر تسرب المياه؟", a: "تُصمم الأحواض والتمديدات بطريقة تقلل مخاطر التسرب، مع فحص نقاط التوصيل قبل التسليم. وفي حال حدوث طارئ، يتوفر دعم للتعامل مع المشكلة حسب مستوى الخدمة المتفق عليه." },
        { id: newId(), q: "هل الحوض آمن بالقرب من الأطفال والعملاء؟", a: "نعم عند تنفيذه بالشكل الصحيح. نراعي ثبات القاعدة، حماية التوصيلات الكهربائية، مناسبة الارتفاع، وطبيعة المكان، ويمكن إضافة احتياطات إضافية للمواقع التي يرتادها الأطفال." },
        { id: newId(), q: "من سيقوم بإطعام الأسماك؟", a: "يُحدد ذلك حسب الباقة. يمكن أن تكون التغذية ضمن الخدمة المُدارة، أو نوفر للمنشأة تعليمات واضحة وكميات محسوبة تقلل الأخطاء والهدر." },
        { id: newId(), q: "ماذا يحدث عند انقطاع الكهرباء؟", a: "يتأثر الحوض بحسب مدة الانقطاع ونوع النظام. نقدم توصيات مناسبة للموقع، وقد نوصي بحلول احتياطية للمواقع التي تتطلب مستوى حماية أعلى." },
        { id: newId(), q: "هل يحتاج الحوض مساحة كبيرة؟", a: "لا. يتم اختيار المقاس والتصميم بناءً على مساحة الموقع، حركة العملاء، نقطة الرؤية، ومواقع الكهرباء والخدمات دون تعطيل استخدام المساحة." },
        { id: newId(), q: "هل يمكن تخصيص الحوض ليتوافق مع هوية علامتنا التجارية؟", a: "نعم. يمكن تخصيص الألوان، المواد، شكل القاعدة، المشهد الداخلي، وعناصر BrandScape مثل الشعار أو معالم مرتبطة بالمنشأة لتصبح التجربة جزءًا من الهوية البصرية." },
        { id: newId(), q: "هل يمكننا شراء الحوض بدون اشتراك؟", a: "نعم. تتوفر خيارات الشراء المباشر، كما يمكن إضافة الصيانة والدعم لاحقًا حسب احتياج المنشأة." },
        { id: newId(), q: "هل يمكننا تجربة الفكرة قبل الالتزام بعقد طويل؟", a: "نعم. يتيح برنامج التجربة Pilot Program تنفيذ التجربة لفترة محددة وقياس ملاءمتها للموقع قبل اتخاذ قرار طويل المدى." },
        { id: newId(), q: "هل يمكن تطوير الحوض أو تغيير تصميمه مستقبلًا؟", a: "نعم. يمكن تحديث الكائنات الحية، المشهد الداخلي، عناصر الهوية، أو بعض المعدات بحسب حالة النظام وإمكانية التنفيذ." },
        { id: newId(), q: "ماذا لو نقلنا الفرع أو غيّرنا موقع المنشأة؟", a: "يمكن دراسة نقل الحوض وإعادة تركيبه في الموقع الجديد. تعتمد إمكانية النقل وتكلفته على حجم الحوض، المسافة، حالة المعدات، وتجهيزات الموقع الجديد." },
        { id: newId(), q: "كم تستغرق عملية التصميم والتركيب؟", a: "تعتمد المدة على حجم المشروع ودرجة التخصيص وتجهيز الموقع. بعد المعاينة يتم تقديم نطاق زمني واضح للتصميم والتصنيع والتركيب والتشغيل." },
        { id: newId(), q: "ماذا نحتاج لتجهيز الموقع قبل التركيب؟", a: "عادة نحتاج نقطة كهرباء مناسبة، مساحة آمنة ومستوية، وإمكانية الوصول للموقع. بعد المعاينة نزودكم بمتطلبات واضحة قبل موعد التركيب." },
        { id: newId(), q: "كيف نعرف أن الحوض بحالة جيدة بين الزيارات؟", a: "توفر الباقات المؤهلة سجلًا للزيارات والتقارير والصور والملاحظات من خلال بوابة العميل، مما يساعد على متابعة حالة الحوض والخدمات المنفذة." },
        { id: newId(), q: "هل يمكن التواصل معكم عند حدوث ملاحظة بين الزيارات؟", a: "نعم. يمكن التواصل مع فريق Aqua Haven للدعم والإرشاد، وتُحدد سرعة الاستجابة وآلية الطوارئ بحسب الباقة واتفاقية الخدمة." },
        { id: newId(), q: "ما الذي يشمله الاشتراك المُدار؟", a: "يعتمد على الباقة، ويمكن أن يشمل الزيارات الدورية، تنظيف الحوض، فحص المياه والمعدات، التغذية، العناية بالكائنات، التقارير، والدعم الفني." },
        { id: newId(), q: "هل تختلف التكلفة حسب نوع النشاط؟", a: "تتحدد التكلفة بناءً على حجم الحوض، مستوى التخصيص، نوع الكائنات، سهولة الوصول للموقع، عدد الزيارات، ومستوى الدعم المطلوب، وليس على نوع النشاط وحده." },
      ],
    },
...
const businessDefaultsEn: PageDoc = {
  sections: [
    ...
    },
    {
      ...
      heading: "FAQ",
      items: [
        { id: newId(), q: "Will the aquarium produce any odor in our space?", a: "No. A properly designed and managed aquarium does not produce unpleasant odors. The service relies on correct filtration, stable water quality, and routine cleaning that prevents waste buildup." },
        { id: newId(), q: "Will our staff need to look after the aquarium?", a: "No, under fully managed plans. The Aqua Haven team handles scheduled feeding, cleaning, equipment checks, water monitoring, and livestock care. Your team only needs to report anything unusual." },
        { id: newId(), q: "Could maintenance disrupt our customers or operations?", a: "Visits are scheduled at the times that suit your venue best and carried out in an organized, efficient manner, keeping the area clean and minimizing any disruption to customers and staff." },
        { id: newId(), q: "Can maintenance be done before or after business hours?", a: "Yes. Visits can be arranged outside peak hours, before opening, or after closing whenever the site and plan allow." },
        { id: newId(), q: "What happens if a fish dies or plants are damaged?", a: "Coverage depends on the plan and contract. Some managed plans may include replacement under the service policy, after identifying the cause and confirming it is not due to external interference or a situation outside the coverage scope." },
        { id: newId(), q: "What happens if a piece of equipment fails?", a: "We diagnose the fault and take the appropriate action. Repair or replacement is handled under the equipment warranty and the terms of the agreed maintenance plan." },
        { id: newId(), q: "Is there a risk of water leakage?", a: "Aquariums and plumbing are engineered to minimize leakage risk, with connection points inspected before handover. In case of an emergency, support is available in line with the agreed service level." },
        { id: newId(), q: "Is the aquarium safe around children and customers?", a: "Yes, when properly installed. We consider base stability, protection of electrical connections, appropriate height, and the nature of the venue. Additional precautions can be added for locations frequented by children." },
        { id: newId(), q: "Who will feed the fish?", a: "This depends on the plan. Feeding may be included in the managed service, or we provide the venue with clear instructions and measured quantities that reduce errors and waste." },
        { id: newId(), q: "What happens during a power outage?", a: "Impact varies with outage duration and system type. We provide recommendations suited to the site, and may suggest backup solutions for locations that require a higher level of protection." },
        { id: newId(), q: "Does the aquarium require a lot of space?", a: "No. Size and design are selected based on the available area, customer flow, viewing angle, and the location of power and utilities — without disrupting how the space is used." },
        { id: newId(), q: "Can the aquarium be customized to match our brand identity?", a: "Yes. Colors, materials, base shape, interior scape, and BrandScape elements — such as your logo or landmarks related to the venue — can all be tailored so the experience becomes part of your visual identity." },
        { id: newId(), q: "Can we purchase the aquarium without a subscription?", a: "Yes. Direct purchase options are available, and maintenance or support can be added later as the venue needs." },
        { id: newId(), q: "Can we try the concept before committing to a long-term contract?", a: "Yes. The Pilot Program lets you run the experience for a defined period and evaluate its fit for the location before making a long-term decision." },
        { id: newId(), q: "Can the aquarium be upgraded or redesigned in the future?", a: "Yes. Livestock, interior scape, identity elements, or certain equipment can be updated based on the system's condition and feasibility." },
        { id: newId(), q: "What if we relocate the branch or move the venue?", a: "Relocating and reinstalling the aquarium at the new site can be assessed. Feasibility and cost depend on aquarium size, distance, equipment condition, and the readiness of the new location." },
        { id: newId(), q: "How long does design and installation take?", a: "Timeline depends on project size, level of customization, and site readiness. After the site visit, a clear timeframe is provided for design, fabrication, installation, and commissioning." },
        { id: newId(), q: "What do we need to prepare on-site before installation?", a: "Typically a suitable power outlet, a safe and level area, and site access. After the visit, we share clear requirements ahead of the installation date." },
        { id: newId(), q: "How do we know the aquarium is in good condition between visits?", a: "Eligible plans provide a log of visits, reports, photos, and notes through the client portal, helping you follow the aquarium's status and the services performed." },
        { id: newId(), q: "Can we reach you if we notice something between visits?", a: "Yes. You can contact the Aqua Haven team for support and guidance. Response speed and emergency handling are defined by the plan and service agreement." },
        { id: newId(), q: "What is included in the managed subscription?", a: "It depends on the plan and may include scheduled visits, aquarium cleaning, water and equipment checks, feeding, livestock care, reports, and technical support." },
        { id: newId(), q: "Does the cost vary based on the type of business?", a: "Cost is determined by aquarium size, level of customization, type of livestock, site accessibility, number of visits, and the required level of support — not by the business type alone." },
      ],
    },
    {
      id: newId(), type: "lead_form", enabled: true,
...
export const CMS_PAGES: CmsPageMeta[] = [
  ...
  { key: "business_solutions",label: "حلول الأعمال",       route: "/business-solutions",          group: "full",   hint: "صفحة كاملة قابلة للتعديل: هيرو + تبويبات (كافيهات/مطاعم/فعاليات/...) بكل المحتوى.", defaults: businessDefaults, defaults_en: businessDefaultsEn },
