        ...
        <div className="glass rounded-3xl p-8 space-y-5">
          ...
          <button
            ...
            onClick={async () => {
              setBusy(true);
              try {
                try { localStorage.setItem("aqh_post_login_redirect", safeRedirect); } catch {}
                ...
                toast.error("تعذّر تسجيل الدخول باستخدام Google. حاول مرة أخرى.");
              } finally {
                setBusy(false);
              }
            }}
            className="w-full rounded-xl bg-white text-gray-800 hover:bg-gray-100 transition px-6 py-3 text-sm font-medium flex items-center justify-center gap-3 disabled:opacity-60"
          >
            <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
              ...
              <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.3-4.1 5.6l6.2 5.2c-.4.4 6.6-4.8 6.6-14.8 0-1.2-.1-2.3-.4-3.5z"/>
            </svg>
